...
I5 = 255*ones(size(I2,1),size(I2,2),3,'uint8');   % initialise white img

t = pi/2;    %set the angle of rotation
...
for(k=1:size(S,1))
    ...
    for(j=1:size(K{1,1},1))
        ...
        I5(floor(temp(2)),floor(temp(1)),:) =   I4(b,(a-b)/size(I2,1)+1,:);       %assign the info of I4 to I5
